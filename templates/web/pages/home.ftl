...
<p><span>The Refinery offers its Members exclusive entry to our set of inimitable facilities. But membership here is about more than simple conveniences – it grants access to an array of opportunities, to connections with fellow individuals and the stimulating chance to consort with prime movers through select events.</span>&nbsp;</p>                <p>
<a href="https://www.refineryclub.com/en/membership/membership-fee/" class="btn btn-large cta" target="|Custom">Join Us</a>                </p>
        </div>
    </div>
</div>
</div>
...
<ul class="nav nav-footer justify-content-md-center">
        <li class="nav-item">
            <a href="https://www.refineryclub.com/en/main-dining/" class="nav-link " target="">
                Dining
            </a>
        </li>
        <li class="nav-item">
            <a href="https://www.refineryclub.com/en/fitness/" class="nav-link " target="">
                Fitness
            </a>
        </li>
        <li class="nav-item">
            <a href="https://www.refineryclub.com/en/events-and-news/" class="nav-link " target="">
                News And Events
            </a>
        </li>
        <li class="nav-item">
            <a href="https://www.refineryclub.com/en/membership/" class="nav-link " target="">
                Membership
            </a>
        </li>
        <li class="nav-item">
            <a href="https://www.refineryclub.com/en/about/" class="nav-link " target="">
                About
            </a>
        </li>
        <li class="nav-item">
            <a href="https://www.refineryclub.com/en/contact/" class="nav-link " target="">
                Contact
            </a>
        </li>
        <li class="nav-item">
            ...
            <ul class="nav nav-ext justify-content-md-center">
                <li class="nav-item">
                    <span class="nav-item nav-link">
                        © 2025 Taikoo Place Holdings Limited All rights reserved
                    </span>
                </li>
                    <li class="nav-item">
...
<a href="https://www.swireproperties.com/en/privacy-policy.aspx" class="nav-item nav-link" target="_blank">Privacy Policy</a>    </li>
    ...
    <!-- Google tag (gtag.js) -->
    <script async="" src="./Home - The Refinery_files/js"></script>
    <script>
    ...
    <script src="./Home - The Refinery_files/api.js" async="" defer="defer"></script>
    <script src="./Home - The Refinery_files/plugins.js"></script>
    <script src="./Home - The Refinery_files/main.js" async="" defer="defer"></script>
